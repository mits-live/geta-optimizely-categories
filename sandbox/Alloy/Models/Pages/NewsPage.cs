...
using AlloyDemoDotNet6.Business;
using AlloyDemoDotNet6.Models.Blocks;
using AlloyDemoDotNet6.Models.Categories;
...
[SiteImageUrl]
public class NewsPage : StandardPage, ICategorizableContent
{
    [Display(
